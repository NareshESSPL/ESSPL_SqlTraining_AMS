ususe [AccountManagementSystem]
crcreate procedure AMS1.Proc_UserAndAll_Insert
...
as begin
   ...
   insert into AMS1.[User] (UserName, DOB, DOJ, Balance, AccountNo, MobileNo, CreatedBy) values
