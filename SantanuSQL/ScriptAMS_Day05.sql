...
CREATE TABLE Useranalytics (
    ...
    AccountID INT,
    Address VARCHAR(255),
    MappingDetails VARCHAR(255),
    TransactionAmount DECIMAL(10, 2),
    TransactionDate DATE
);

INSERT INTO useranalytics (UserID, UserName, AccountID, Address, MappingDetails, TransactionAmount, TransactionDate)
SELECT 
    u.UserID,
    u.UserName,
    a.AccountID,
...
FROM 
    user u
JOIN 
    useraccountmapping uam ON u.UserID = uam.UserID
JOIN 
    account a ON uam.AccountID = a.AccountID
JOIN 
    addressdetails ad ON u.UserID = ad.UserID
JOIN 
    accounttransactions at ON a.AccountID = at.AccountID;
