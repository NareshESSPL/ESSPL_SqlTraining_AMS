...
Desc : Stored Procedure for User table insertion
*/
CREATE PROCEDURE AMS.Proc_User_Insert3
...
-- Example execution
EXEC AMS.Proc_User_Insert3'Alice Johnson', '1985-01-15', '2025-01-01', 1000.00, 1010, 9876543210;
EXEC AMS.Proc_User_Insert3 'Bob Smith', '1990-02-20', '2025-02-01', 2000.00, 1011, 9876543211;
EXEC AMS.Proc_User_Insert3 'Charlie Brown', '1995-03-25', '2025-03-01', 3000.00, 1012, 9876543212;
EXEC AMS.Proc_User_Insert3 'David Wilson', '1988-04-30', '2025-04-01', 4000.00, 1013, 9876543213;
EXEC AMS.Proc_User_Insert3 'Eva Green', '1992-05-05', '2025-05-01', 5000.00, 1014, 9876543214;
EXEC AMS.Proc_User_Insert3 'Frank White', '1980-06-10', '2025-06-01', 6000.00, 1015, 9876543215;
GO
...
*/
CREATE PROCEDURE AMS.Proc_Account_Insert3
    @AccountNo INT,
    @IsSaving BIT,
    @CreatedBy VARCHAR(250) = 'system'
AS 
...
--Example Execution
EXEC AMS.Proc_Account_Insert3 1010, 1;
EXEC AMS.Proc_Account_Insert3 1011, 0;
EXEC AMS.Proc_Account_Insert3 1012, 1;
EXEC AMS.Proc_Account_Insert3 1013, 0;
EXEC AMS.Proc_Account_Insert3 1014, 1;
EXEC AMS.Proc_Account_Insert3 1015, 0;
...
*/
CREATE PROCEDURE AMS.Proc_Address_Insert3
@UserName NVARCHAR(250),
@DOB DATETIME,
@DOJ DATETIME,
@Balance DECIMAL(10,6),
...
-- Example execution
EXEC AMS.Proc_Address_Insert3 'Alice Johnson', '1985-01-15', '2025-01-01', 1000.00, 1010, 9876543210, 'Maple St, Springfield, IL';
EXEC AMS.Proc_Address_Insert3 'Bob Smith', '1990-02-20', '2025-02-01', 2000.00, 1011, 9876543211, 'Oak St, Springfield, IL';
EXEC AMS.Proc_Address_Insert3 'Charlie Brown', '1995-03-25', '2025-03-01', 3000.00, 1012, 9876543212, 'Pine St, Springfield, IL';
EXEC AMS.Proc_Address_Insert3 'David Wilson', '1988-04-30', '2025-04-01', 4000.00, 1013, 9876543213, 'Birch St, Springfield, IL';
EXEC AMS.Proc_Address_Insert3 'Eva Green', '1992-05-05', '2025-05-01', 5000.00, 1014, 9876543214, '';
EXEC AMS.Proc_Address_Insert3 'Frank White', '1980-06-10', '2025-06-01', 6000.00, 1015, 9876543215, 'Elm St, Springfield, IL';
GO
...
*/
CREATE PROCEDURE AMS.Proc_AccountAndAccountTransaction_Insert3
    @AccountNo INT,
    @IsSaving BIT,
    @Amount DECIMAL(10, 6),
    @IsDebit BIT,
...
-- Example Execution
EXEC AMS.Proc_AccountAndAccountTransaction_Insert3 1010, 1, 150.00, 1, 'system';
EXEC AMS.Proc_AccountAndAccountTransaction_Insert3 1011, 0, 50.00, 0, 'system';
EXEC AMS.Proc_AccountAndAccountTransaction_Insert3 1012, 1, 200.00, 1, 'system';
EXEC AMS.Proc_AccountAndAccountTransaction_Insert3 1013, 1, 100.00, 0, 'system';
EXEC AMS.Proc_AccountAndAccountTransaction_Insert3 1014, 0, 300.00, 1, 'system';
EXEC AMS.Proc_AccountAndAccountTransaction_Insert3 1015, 0, 150.00, 0, 'system';
...
*/
CREATE PROCEDURE AMS.Proc_UserAccountMapping_Insert3
@UserName NVARCHAR(250),
@DOB DATETIME,
@DOJ DATETIME,
@Balance DECIMAL(10,6),
...
-- Example execution
EXEC AMS.Proc_UserAccountMapping_Insert3 'Alice Johnson', '1985-01-15', '2025-01-01', 1000.00, 1010, 9876543210, 1, 150.00, 1;
EXEC AMS.Proc_UserAccountMapping_Insert3 'Bob Smith', '1990-02-20', '2025-02-01', 2000.00, 1011, 9876543211, 0, 50.00, 0;
EXEC AMS.Proc_UserAccountMapping_Insert3 'Charlie Brown', '1995-03-25', '2025-03-01', 3000.00, 1012, 9876543212, 1, 200.00, 1;
EXEC AMS.Proc_UserAccountMapping_Insert3 'David Wilson', '1988-04-30', '2025-04-01', 4000.00, 1013, 9876543213, 0, 100.00, 0;
EXEC AMS.Proc_UserAccountMapping_Insert3 'Eva Green', '1992-05-05', '2025-05-01', 5000.00, 1014, 9876543214, 1, 300.00, 1;
EXEC AMS.Proc_UserAccountMapping_Insert3 'Frank White', '1980-06-10', '2025-06-01', 6000.00, 1015, 9876543215, 0, 150.00, 0;
