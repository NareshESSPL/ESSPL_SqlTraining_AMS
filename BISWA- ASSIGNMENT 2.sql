...
VALUES
	...
	Delete from AMS.[UserAccountMapping];
	DBCC CHECKIDENT ('AMS.[UserAccountMapping]', RESEED, 0)
...
VALUES
    ( 1,  'Vani vihar', 'Admin', CURRENT_TIMESTAMP),
    ( 2, 'jaydev vihar' , 'Admin', CURRENT_TIMESTAMP),
    ( 3, 'acharya vihar', 'Admin', CURRENT_TIMESTAMP);
