...
/*Introduce a column as MVC(most valuable customer) with balance more than average balance based on
age group and do a ranking based on that*/
...
select 
    ...
    x.Age,
    CASE 
        WHEN x.Age > 10 AND x.Age <= 20 THEN 'A'
        WHEN x.Age > 20 AND x.Age <= 30 THEN 'B'
        WHEN x.Age > 30 AND x.Age <= 45 THEN 'C'
        WHEN x.Age > 45 THEN 'D'
        ELSE 'Invalid Age' 
end
from
(
